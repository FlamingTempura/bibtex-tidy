...
function formatNode(child, options, indent, omitFields, replacementKeys) {
  ...
  switch (child.block.type) {
    ...
    case "entry":
      var _replacementKeys;
      return formatEntry(child.command, child.block, options, indent, omitFields, (_replacementKeys = replacementKeys) === null || _replacementKeys === void 0 ? void 0 : _replacementKeys.get(child.block)) + (options.blankLines ? "\n" : "");
  }
}
