...
function wrapText(line, lineWidth) {
  ...
  var lines = [""];
  var _iterator2 = _createForOfIteratorHelper(words2),
    _step2;
  try {
...
function sortEntries(ast, fieldMaps, sort) {
  ...
  var precedingMeta = [];
  var _iterator3 = _createForOfIteratorHelper(ast.children),
    _step3;
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      ...
      var _iterator4 = _createForOfIteratorHelper(sort),
        _step4;
      try {
...
function checkForDuplicates(ast, valueLookup, duplicateRules, merge) {
  ...
  if (duplicateRules) {
    var _iterator6 = _createForOfIteratorHelper(duplicateRules),
      _step6;
    try {
      ...
      try {
        for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
          var _step8$value = _slicedToArray(_step8.value, 2),
            _rule = _step8$value[0],
            doMerge = _step8$value[1];
...
function mergeEntries(merge, duplicateOf, entry) {
  switch (merge) {
    ...
    case "combine":
    case "overwrite":
      var _iterator9 = _createForOfIteratorHelper(entry.fields),
        _step9;
      try {
...
function generateKeys(ast, valueLookup, template) {
  ...
  var keys = /* @__PURE__ */new Map();
  var _iterator11 = _createForOfIteratorHelper(entriesByKey),
    _step11;
  try {
    for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
      var _step11$value = _slicedToArray(_step11.value, 2),
        key = _step11$value[0],
        entries = _step11$value[1];
...
function generateKey(valueLookup, template) {
  try {
    var newKey = template.replace(/\[[^:\]]+(?::[^:\]]+)*\]/g, m => {
      ...
      var _iterator12 = _createForOfIteratorHelper(modifierKeys),
        _step12;
      try {
        for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
          var modifierKey = _step12.value;
