 ...
 **/
declare type BibTeXTidyOptions = {
    /**
     * Help
     *
     * Show help
...
declare type DuplicateRule = Exclude<BibTeXTidyOptions["duplicates"], boolean | undefined>[number];

declare type Options = Omit<BibTeXTidyOptions, "help" | "version" | "quiet" | "backup">;
